; $Id: loadct.pro,v 1.1.1.1 2003/10/21 19:33:48 mamd Exp $
;
...
common mamdvar, num_table, scale, ps_sizex, ps_sizey, PSFILE, cXSIZE, cYSIZE
...
; Ajoute par MAMD 6/2/98 pour avoir le numero de la table courante
; en COMMON - utilise par ps.pro
num_table = table_number
