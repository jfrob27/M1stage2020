function ccr1d, image1, image2, lagmax, indef=indef, ccr2dim=ccr2dim, dl=dl
...
ccr2d, image1, image2, lagmax, ccr2dim, nbpoint2d, indef=indef

ind = where(image1 ne indef and image2 ne indef)
ccr2dim = ccr2dim / (stdev(image1(ind)) * stdev(image2(ind)))
